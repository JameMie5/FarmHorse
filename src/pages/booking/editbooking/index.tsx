...
const Users = (): React.JSX.Element => {
  ...
  const breadcrumbItems = [
    ...
    { text: 'EditBooking', href: '/booking/editbooking' },
  ]
  ...
  const handleClick = (dateObj: { dateTime: string }, index: number) => {
    ...
    setClickedIndex(index) // เมื่อปุ่มถูกคลิกให้กำหนด index ของปุ่มที่ถูกคลิกให้กับ state
          ...
          <div className="">
            ...
            <div className="row">
              ...
              <div className="p-4">
                {notshowDetails && (
                  <div>
                    {BookingListA && BookingListA.length > 0 && (
                      <div>
                        <div className="col-6">
                          <div className="input-group mb-3">
                            <input disabled type="text" value={BookingListA[0].cdate} className="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" />
              ...
              <div className='p-4'>
                {BookingListA && BookingListA.length > 0 && (
                  <div>
                    <div className="col-6">
                      <div className="input-group mb-3">
                        <input disabled type="text" value={`${BookingListA[0].booking_fdatetime} - ${BookingListA[0].booking_tdatetime}`} className="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" />
                        <span className="input-group-text" id="basic-addon1">
                          <i className="fa-solid fa-pen-to-square"></i>
                        </span>
                      </div>
